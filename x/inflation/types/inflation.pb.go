...
// source: ambinet/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "ambinet.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "ambinet.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("ambinet/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
