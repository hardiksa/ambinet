...
// source: ambinet/epochs/v1/genesis.proto
...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "ambinet.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "ambinet.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("ambinet/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
