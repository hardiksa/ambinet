...
func init() {
	proto.RegisterEnum("ambinet.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "ambinet.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "ambinet.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "ambinet.claims.v1.ClaimsRecord")
}
