...
// source: ambinet/claims/v1/claims.proto
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=ambinet.claims.v1.Action" json:"action,omitempty"`
...
func init() {
	proto.RegisterEnum("ambinet.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "ambinet.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "ambinet.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "ambinet.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("ambinet/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
