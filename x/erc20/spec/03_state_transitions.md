...
3. If Cosmos coin or IBC voucher already exist on the bank module supply, create the [ERC20 token contract](https://github.com/hardiksa/ambinet/blob/main/contracts/ERC20MinterBurnerDecimals.sol) on the EVM based on the ERC20Mintable ([ERC20Mintable by openzeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts/tree/master/contracts/token/ERC20)) interface
    - Initial supply: 0
