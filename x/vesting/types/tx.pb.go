...
// source: ambinet/vesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateClawbackVestingAccount)(nil), "ambinet.vesting.v1.MsgCreateClawbackVestingAccount")
	proto.RegisterType((*MsgCreateClawbackVestingAccountResponse)(nil), "ambinet.vesting.v1.MsgCreateClawbackVestingAccountResponse")
	proto.RegisterType((*MsgClawback)(nil), "ambinet.vesting.v1.MsgClawback")
	proto.RegisterType((*MsgClawbackResponse)(nil), "ambinet.vesting.v1.MsgClawbackResponse")
}

func init() { proto.RegisterFile("ambinet/vesting/v1/tx.proto", fileDescriptor_d5db113bc0c7240c) }
...
func (c *msgClient) CreateClawbackVestingAccount(ctx context.Context, in *MsgCreateClawbackVestingAccount, opts ...grpc.CallOption) (*MsgCreateClawbackVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ambinet.vesting.v1.Msg/CreateClawbackVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Clawback(ctx context.Context, in *MsgClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ambinet.vesting.v1.Msg/Clawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateClawbackVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ambinet.vesting.v1.Msg/CreateClawbackVestingAccount",
	}
...
func _Msg_Clawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ambinet.vesting.v1.Msg/Clawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ambinet.vesting.v1.Msg",
	...
	Metadata: "ambinet/vesting/v1/tx.proto",
}
