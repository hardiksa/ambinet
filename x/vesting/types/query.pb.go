...
// source: ambinet/vesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "ambinet.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "ambinet.vesting.v1.QueryBalancesResponse")
}

func init() { proto.RegisterFile("ambinet/vesting/v1/query.proto", fileDescriptor_ff0457b141ab5d28) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ambinet.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ambinet.vesting.v1.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ambinet.vesting.v1.Query",
	...
	Metadata: "ambinet/vesting/v1/query.proto",
}
