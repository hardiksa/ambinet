...
Find below a list of `ambinetd` commands added with the `x/vesting` module. You can obtain the full list by using the `ambinetd -h` command.
...
```go
ambinetd query vesting balances [address] [flags]
```
...
```go
ambinetd tx vesting create-clawback-vesting-account [to_address] [flags]
```
...
```go
ambinetd tx vesting clawback [address] [flags]
```
...
| ------ | -------------------------------------- | -------------------------------------- |
| `gRPC` | `ambinet.vesting.v1.Query/Balances`      | Gets locked, unvested and vested coins |
| `GET`  | `/ambinet/vesting/v1/balances/{address}` | Gets locked, unvested and vested coins |

### Transactions

| Verb   | Method                                                 | Description                      |
| ------ | ------------------------------------------------------ | -------------------------------- |
| `gRPC` | `ambinet.vesting.v1.Msg/CreateClawbackVestingAccount`    | Creates clawback vesting account |
| `gRPC` | `/ambinet.vesting.v1.Msg/Clawback`                       | Performs clawback                |
| `GET`  | `/ambinet/vesting/v1/tx/create_clawback_vesting_account` | Creates clawback vesting account |
| `GET`  | `/ambinet/vesting/v1/tx/clawback`                        | Performs clawback                |
