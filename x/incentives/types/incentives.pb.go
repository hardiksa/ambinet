...
// source: ambinet/incentives/v1/incentives.proto
...
func init() {
	proto.RegisterType((*Incentive)(nil), "ambinet.incentives.v1.Incentive")
	proto.RegisterType((*GasMeter)(nil), "ambinet.incentives.v1.GasMeter")
	proto.RegisterType((*RegisterIncentiveProposal)(nil), "ambinet.incentives.v1.RegisterIncentiveProposal")
	proto.RegisterType((*CancelIncentiveProposal)(nil), "ambinet.incentives.v1.CancelIncentiveProposal")
}

func init() {
	proto.RegisterFile("ambinet/incentives/v1/incentives.proto", fileDescriptor_95b81e40854aec77)
}
