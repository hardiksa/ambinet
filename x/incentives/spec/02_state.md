...
Say, there are several incentives that have registered an allocation for the $AMBINET coin and the allocation meter for $AMBINET is at 97%. Then a new incentve proposal can only include an $AMBINET allocation at up to 3%, claiming the last remaining allocation capcaity from the $AMBINET rewards in the inflation pool.
