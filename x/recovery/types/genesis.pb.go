...
// source: ambinet/recovery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "ambinet.recovery.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "ambinet.recovery.v1.Params")
}

func init() { proto.RegisterFile("ambinet/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
