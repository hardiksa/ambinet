...
Connect your Keplr wallet with Ambinet {synopsis}
...
Once you are signed in to the Keplr extension, you can connect the wallet with the Ambinet network. The Ambinet mainnet network is already built into Keplr; look for the `Ambinet (beta)` network.
