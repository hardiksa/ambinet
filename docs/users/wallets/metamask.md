...
::: tip
If you are planning on developing on Ambinet locally and you haven’t already set up your own local node, refer to [the quickstart tutorial](../../validators/quickstart/run_node.md), or follow the instructions in the [GitHub repository](https://github.com/hardiksa/ambinet/).
:::
...
```bash
ambinetd keys unsafe-export-eth-key mykey
```
