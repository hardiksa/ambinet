...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/hardiksa/ambinet/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Ambinet is hosted at [ambinet.dev](https://ambinet.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/hardiksa/ambinet/tree/main/docs).
