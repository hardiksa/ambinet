...
preparing test network with chain-id "ambinet_1276974-1"
...
```bash
ambinetd keys add test --recover
```

Check the balance of the account address:

```bash
ambinetd q bank balances [address]
```
