...
```bash
ambinetd start --json-rpc.enable
```
...
```bash
ambinetd start --json-rpc.api eth,txpool,personal,net,debug,web3,miner
```
...
```bash
# set gas cap to 85M
ambinetd start --json-rpc.gas-cap 85000000000

# set gas cap to infinite (=0)
ambinetd start --json-rpc.gas-cap 0
```
